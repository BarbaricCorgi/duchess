defmodule ISO8583 do
  ...
  def parse_fields(fields_descriptors, fields_list, hex, result_map, :numeric, :variable_ll) do
    [current_field | other_fields] = fields_list
  ...
  def parse_fields(fields_descriptors, fields_list, hex, result_map, :numeric, :variable_lll) do
    [current_field | other_fields] = fields_list
  ...
  def parse_fields(fields_descriptors, fields_list, hex, result_map, :alphanumeric, :variable_ll) do
    [current_field | other_fields] = fields_list
    <<size::binary-size(1), size_rest_hex::bitstring>> = hex
