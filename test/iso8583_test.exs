defmodule ISO8583Test do
  ...
  test "Parses numeric field" do
    ...
    assert {:ok, "000398"} = ISO8583.parse_field_numeric(:fixed, 3, numeric_field_hex)
  end
  ...
  test "Parses 0210 message" do
    ...
    message_0210_hex = <<
      ...
      0x02, 0x10,
      0x20, 0x38, 0x01, 0x00, 0x0A, 0x80, 0x00, 0x00,
#      0x20, 0x38, 0x01, 0x00, 0x0A, 0x80, 0x04, 0x00,
      ...
      #,0x00, 0x12, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30
    >>
